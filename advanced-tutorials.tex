...
\textbf{Demo Suite}: \lstinline=~/tutorial/suites/family-triggers=
\end{shaded*}
...
\textbf{Demo Suite}: \lstinline=~/tutorial/suites/retries=
\end{shaded*}
...
\textbf{Demo Suite}: \lstinline=~/tutorial/suites/jinja2=
\end{shaded*}
...
\textbf{Demo Suite}: \lstinline=~/tutorial/suites/broadcast=
\end{shaded*}
...
\textbf{Demo Suite}: \lstinline=~/tutorial/suites/suicide-triggers=
\end{shaded*}
...
\textbf{Demo Suite}: \lstinline=~/tutorial/suites/queues=
\end{shaded*}

\subsection{Clock Triggered Tasks}
\label{Clock Triggered Tasks}

Sometimes tasks need to wait until a certain real clock time before running. To
...
\textbf{Demo Suite}: \lstinline=~/tutorial/suites/clock-triggers=
\end{shaded*}
